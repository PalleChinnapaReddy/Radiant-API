...
{
    public class ConsolidatedAttendancebyMonth
    {
        ...
        public decimal? WeekOffPresent { get; set; }
        public decimal? HolidayPresent { get; set; }
        public decimal? CompOff { get; set; }
        public decimal? InActivePresent { get; set; }
        ...
        public decimal? OtHoursApproved { get; set; }
